...
public class RecursionProcessingComparisonTest {
...
//    @Rule
//    public Timeout globalTimeout = new Timeout(1600);
            ...
            for (int j = 1; j <= 6; j++) {
                ...
                switch (item.dataType) {
                    case NUMERIC:
                        ...
                        break;
                    case TEXT:
                        comparisonItem.equation = "return 'Comparison sample equation'";
                        break;
                    case DATE:
                ...
                if (i == 2) {
                    comparisonItem.messageTemplate = "GURAMA tavi 1 abzaci 9";
                }
