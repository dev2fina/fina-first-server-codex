...
public class GenerateUpdateStatement extends AbstractGenerateStatement {

    public GenerateUpdateStatement(DatabaseInterface databaseInterface, List<InputMetaModel> fields, List<InputMetaModel> extraFields) {
