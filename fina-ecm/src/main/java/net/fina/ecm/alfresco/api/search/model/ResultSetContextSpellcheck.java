 ...
 */
public class ResultSetContextSpellcheck implements BaseRepresentation {
    /**
     * Gets or Sets type
     */
    public enum TypeEnum {
        @JsonProperty("searchInsteadFor") SEARCHINSTEADFOR("searchInsteadFor"),

        @JsonProperty("didYouMean") DIDYOUMEAN("didYouMean");
